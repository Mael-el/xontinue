// ============================================================
// PAGE MARKETING (visiteurs anonymes) — AfricaSkills
...
// Extraite de / : affichée aux visiteurs NON connectés — les
// connectés voient le fil social (src/components/feed/SocialFeed).
